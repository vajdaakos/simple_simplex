...
namespace Ui {
class Mainvindow_gui_plugin_for_fules;
}

class Mainvindow_gui_plugin_for_fules : public QWidget, public Mainwindow_Gui_Plugin_Interface
{
    Q_OBJECT
...
public:
    explicit Mainvindow_gui_plugin_for_fules(QWidget *parent = nullptr);
    ~Mainvindow_gui_plugin_for_fules() override;
...
public slots:
    void do_set_indulo_model_view(QStandardItemModel *model) Q_DECL_OVERRIDE;
    void do_set_kanonikus_alak_model_view(QStandardItemModel *model) Q_DECL_OVERRIDE;
    void do_set_indulo_matrix_model_view(QStandardItemModel *model) Q_DECL_OVERRIDE;
    void do_set_utolso_elotti_allapot_model_view(QStandardItemModel *model) Q_DECL_OVERRIDE;
    void do_set_utolso_allapot_model_view(QStandardItemModel *model) Q_DECL_OVERRIDE;
...
private:
    Ui::Mainvindow_gui_plugin_for_fules *ui;
    Delegate_for_numbers_in_fules *number_delegator;
    Non_numeric_Delegate_in_fules *non_numeric_delegate;
};
